...
#define PARA_SUBATTR_ACCESS     (PARA_COLUMN_OFFSET + 9)
#define PARA_OBJECT_DICT        (PARA_COLUMN_OFFSET + 10)
#define PARA_NAME_ZH            (PARA_COLUMN_OFFSET + 11)
#define PARA_DESC_ZH            (PARA_COLUMN_OFFSET + 12)
    ...
    QTextStream& ParaAttr)
{
    ...
    static const QMap<QString, ParaRwMode_t> sMapRwMode = {
        ...
        {"读写 - 立即更改，重启生效", {2, 2, "B_RW_M1"}},
        {"读写 - 停机更改，立即生效", {2, 1, "B_RW_M2"}},
    };
    ...
    QString styleAttr = "    { %1, %2, %3, %4 | %5 | %6 | %7 | %8 | %9 }, // P%10 %11";
