...
void wk_gpio_config(void)
{
  ...
  /* gpio output config */
  gpio_bits_reset(GPIOB, FlexCH0_PIN | FlexCH1_PIN | FlexCH2_PIN | DO0_PIN | DO1_PIN | 
                  FlexCH3_PIN);
  gpio_bits_reset(GPIOF, LED1_PIN | LED2_PIN);

  gpio_init_struct.gpio_drive_strength = GPIO_DRIVE_STRENGTH_STRONGER;
  gpio_init_struct.gpio_out_type = GPIO_OUTPUT_PUSH_PULL;
  gpio_init_struct.gpio_mode = GPIO_MODE_OUTPUT;
  gpio_init_struct.gpio_pins = FlexCH0_PIN | FlexCH1_PIN | FlexCH2_PIN | FlexCH3_PIN;
  gpio_init_struct.gpio_pull = GPIO_PULL_NONE;
  gpio_init(GPIOB, &gpio_init_struct);
...
void wk_tmr1_init(void)
{
  ...
  // tmr_channel_value_set(TMR1, TMR_SELECT_CHANNEL_1, 65535);
...
void wk_tmr3_init(void)
{
  ...
  // tmr_input_struct.input_filter_value = 5;
...
void wk_adc1_init(void)
{
  ...
  adc_ordinary_channel_set(ADC1, ADC_CHANNEL_3, 2, ADC_SAMPLETIME_55_5);
  adc_ordinary_channel_set(ADC1, ADC_CHANNEL_4, 3, ADC_SAMPLETIME_55_5);
  adc_ordinary_channel_set(ADC1, ADC_CHANNEL_5, 4, ADC_SAMPLETIME_55_5);
  adc_ordinary_channel_set(ADC1, ADC_CHANNEL_16, 5, ADC_SAMPLETIME_28_5);
...
/**
  * @brief  init dma1 channel4 for "tmr5_overflow"
  * @param  none
  * @retval none
  */
void wk_dma1_channel4_init(void)
{
  ...
  /* flexible function enable */
  dma_flexible_config(DMA1, FLEX_CHANNEL4, DMA_FLEXIBLE_TMR5_OVERFLOW);
