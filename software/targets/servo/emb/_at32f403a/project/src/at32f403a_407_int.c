...
void DMA1_Channel1_IRQHandler(void)
{
    ...
    {
        // t1 = tmr_counter_value_get(TIM_SCAN_A);
...
void TMR1_OVF_TMR10_IRQHandler(void)
{
    ...
    if (tmr_interrupt_flag_get(TIM_SCAN_A, TMR_OVF_FLAG) != RESET)
    {
        // t2 = tmr_counter_value_get(TIM_SCAN_A);

        tmr_flag_clear(TIM_SCAN_A, TMR_OVF_FLAG);
    }
...
void TMR6_GLOBAL_IRQHandler(void)
{
    ...
    if (tmr_interrupt_flag_get(TIM_BASE, TMR_OVF_FLAG) != RESET)
    {
        tmr_flag_clear(TIM_BASE, TMR_OVF_FLAG);
        IncTickMs();
    }
...
void TMR7_GLOBAL_IRQHandler(void)
{
    ...
    if (tmr_interrupt_flag_get(TIM_SCAN_B, TMR_OVF_FLAG) != RESET)
    {
        tmr_flag_clear(TIM_SCAN_B, TMR_OVF_FLAG);
        SchedIsrB();
    }
