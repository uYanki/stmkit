/*!
    @file     Ttm638plus.cpp
    @author   Gavin Lyons
    @brief    PICO library TM1638, Source file for TM1638 module(LED & KEY). Model 1 & Model 3.
*/
...
/*!
    @brief Constructor for class TM1638
    @param strobe  GPIO STB pin
    @param clock  GPIO CLK pin
    @param data  GPIO DIO pin
*/
TM1638::TM1638(uint8_t strobe, uint8_t clock, uint8_t data) : TM1638_DRV(strobe, clock, data)
{
    // Blank constructor
}
