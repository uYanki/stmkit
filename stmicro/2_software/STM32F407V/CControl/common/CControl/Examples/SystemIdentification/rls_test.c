...
int CControl_Test()
{
    ...
    size_t i, count = 0;         /* Initial set to 0. Will be counted to 2 then stop. Set count = 0 again and the algorithm starts over */
...
/* Octave code:
    ...
    [Gd, Hd, sysd, K] = mi.rls(u, y, 5, 5, 5, t(2)-t(1), 0, 0.99); % sysd contains K at column 2 of B
