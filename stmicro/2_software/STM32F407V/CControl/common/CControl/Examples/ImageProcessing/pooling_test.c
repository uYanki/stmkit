...
int CControl_Test()
{
    ...
    /* Create X */
    float X[row * column] = {0.950541, 0.565081, 0.233296, 0.134038, 0.092543, 0.174173, 0.675002, 0.271878, 0.921699, 0.296898,
    ...
    /* Create P - Important to have () for avoiding floats */
    float P[(row / p) * (column / p)];

    /* Do pooling */
    pooling(X, P, row, column, p, POOLING_METHOD_SHAPE);
