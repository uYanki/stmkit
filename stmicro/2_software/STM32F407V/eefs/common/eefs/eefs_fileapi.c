...
uint32_t              EEFS_FileDescriptorsInUse;
uint32_t              EEFS_FileDescriptorsHighWaterMark;
...
int32_t    EEFS_LibOpenFile(EEFS_InodeTable_t* InodeTable, int32_t InodeIndex, uint32_t Flags, uint32_t Attributes);
int32_t    EEFS_LibCreatFile(EEFS_InodeTable_t* InodeTable, char* Filename, uint32_t Attributes);
uint32_t   EEFS_LibFmode(EEFS_InodeTable_t* InodeTable, uint32_t InodeIndex);
int32_t    EEFS_LibFindFile(EEFS_InodeTable_t* InodeTable, char* Filename);
int32_t    EEFS_LibGetFileDescriptor(void);
int32_t    EEFS_LibFreeFileDescriptor(int32_t FileDescriptor);
uint8_t    EEFS_LibIsValidFileDescriptor(int32_t FileDescriptor);
uint8_t    EEFS_LibHasOpenCreat(EEFS_InodeTable_t* InodeTable);
uint8_t    EEFS_LibIsValidFilename(char* Filename);
...
int32_t EEFS_LibFreeFS(EEFS_InodeTable_t* InodeTable)
{
    int32_t ReturnCode;
    ...
    if (InodeTable != NULL)
    {
        ...
        { /* files or directory descriptor open */
...
int32_t EEFS_LibOpen(EEFS_InodeTable_t* InodeTable, char* Filename, uint32_t Flags, uint32_t Attributes)
{
    int32_t InodeIndex;
    int32_t ReturnCode;
 ...
 * on error.*/
int32_t EEFS_LibCreat(EEFS_InodeTable_t* InodeTable, char* Filename, uint32_t Attributes)
{
    int32_t InodeIndex;
    int32_t ReturnCode;
...
int32_t EEFS_LibOpenFile(EEFS_InodeTable_t* InodeTable, int32_t InodeIndex, uint32_t Flags, uint32_t Attributes)
{
    ...
    if ((Flags & ~(O_RDONLY | O_WRONLY | O_RDWR | O_TRUNC | O_CREAT)) == 0)
    {
        ...
        if (((Flags & O_ACCMODE) == O_RDONLY) || /* open only for reading OR */
            (EEFS_LIB_IS_WRITE_PROTECTED == FALSE))
        { /* open for writing and the file system is not write protected */
            ...
            if (((Flags & O_ACCMODE) == O_RDONLY) || /* open only for reading OR */
                (FileHeader.Attributes & EEFS_ATTRIBUTE_READONLY) == 0)
            { /* open for writing and read only file attribute not set */
                ...
                if (((Flags & O_ACCMODE) == O_RDONLY) || /* open only for reading OR */
                    (Fmode & EEFS_FWRITE) == 0)
                { /* open for writing and file is not already open for writing */
    ...
    if (EEFS_LIB_IS_WRITE_PROTECTED == FALSE)
    {
        ...
        if (InodeTable->NumberOfFiles < EEFS_MAX_FILES)
        {
            ...
            if (EEFS_LibHasOpenCreat(InodeTable) == FALSE)
            {
                ...
                { /* not enough free space in eeprom */
                    ReturnCode = EEFS_NO_SPACE_LEFT_ON_DEVICE;
                }
            }
            else
            { /* a file creat is already in progress */
                ReturnCode = EEFS_PERMISSION_DENIED;
            }
        }
        else
        { /* no available slots in the File Allocation Table */
            ReturnCode = EEFS_NO_SPACE_LEFT_ON_DEVICE;
        }
    }
    else
...
int32_t EEFS_LibClose(int32_t FileDescriptor)
{
    EEFS_FileAllocationTable_t*      FileAllocationTable;
    EEFS_FileAllocationTableHeader_t FileAllocationTableHeader;
    EEFS_FileAllocationTableEntry_t  FileAllocationTableEntry;
    ...
    if (EEFS_LibIsValidFileDescriptor(FileDescriptor) == TRUE)
    {
        ...
        if (EEFS_FileDescriptorTable[FileDescriptor].Mode & EEFS_FCREAT)
        {
            ...
            FileAllocationTableEntry.FileHeaderOffset = (uint32_t)(InodeTable->File[InodeIndex].FileHeaderPointer - InodeTable->BaseAddress);
            ...
            EEFS_LIB_EEPROM_READ(&FileAllocationTableHeader, &FileAllocationTable->Header, sizeof(EEFS_FileAllocationTableHeader_t));
            FileAllocationTableHeader.FreeMemoryOffset = (uint32_t)(InodeTable->FreeMemoryPointer - InodeTable->BaseAddress);
 ...
 * on error. */
int32_t EEFS_LibRead(int32_t FileDescriptor, void* Buffer, uint32_t Length)
{
 ...
 * on error. */
int32_t EEFS_LibWrite(int32_t FileDescriptor, void* Buffer, uint32_t Length)
{
...
int32_t EEFS_LibLSeek(int32_t FileDescriptor, int32_t ByteOffset, uint16_t  Origin)
{
    ...
    if (EEFS_LibIsValidFileDescriptor(FileDescriptor) == TRUE)
    {
        ...
        if (Origin == SEEK_SET)
        {
            ...
            else if (ByteOffset > (int32_t)EEFS_FileDescriptorTable[FileDescriptor].FileSize)
            {
        ...
        {
            if ((int32_t)(ByteOffset + EEFS_FileDescriptorTable[FileDescriptor].ByteOffset) < 0)
            {
                ReturnCode = EEFS_INVALID_ARGUMENT;
            }
            else if ((int32_t)(ByteOffset + EEFS_FileDescriptorTable[FileDescriptor].ByteOffset) > (int32_t)EEFS_FileDescriptorTable[FileDescriptor].FileSize)
            {
                EEFS_FileDescriptorTable[FileDescriptor].FileDataPointer = EndOfFilePointer;
                EEFS_FileDescriptorTable[FileDescriptor].ByteOffset      = EEFS_FileDescriptorTable[FileDescriptor].FileSize;
                ReturnCode                                               = EEFS_FileDescriptorTable[FileDescriptor].ByteOffset;
        ...
        {
            if ((int32_t)(ByteOffset + EEFS_FileDescriptorTable[FileDescriptor].FileSize) < 0)
            {
                ReturnCode = EEFS_INVALID_ARGUMENT;
            }
...
int32_t EEFS_LibRemove(EEFS_InodeTable_t* InodeTable, char* Filename)
{
    int32_t             InodeIndex;
    EEFS_FileHeader_t FileHeader;
    int32_t             ReturnCode;
...
int32_t EEFS_LibRename(EEFS_InodeTable_t* InodeTable, char* OldFilename, char* NewFilename)
{
    int32_t             InodeIndex;
    EEFS_FileHeader_t FileHeader;
    int32_t             ReturnCode;
 ...
 * or EEFS_INVALID_ARGUMENT on error. */
int32_t EEFS_LibStat(EEFS_InodeTable_t* InodeTable, char* Filename, EEFS_Stat_t* StatBuffer)
{
    int32_t             InodeIndex;
    EEFS_FileHeader_t FileHeader;
    int32_t             ReturnCode;
...
int32_t EEFS_LibFstat(int32_t FileDescriptor, EEFS_Stat_t* StatBuffer)
{
    EEFS_FileHeader_t FileHeader;
    int32_t             ReturnCode;
...
int32_t EEFS_LibSetFileAttributes(EEFS_InodeTable_t* InodeTable, char* Filename, uint32_t Attributes)
{
    int32_t             InodeIndex;
    EEFS_FileHeader_t FileHeader;
    int32_t             ReturnCode;
...
EEFS_DirectoryDescriptor_t* EEFS_LibOpenDir(EEFS_InodeTable_t* InodeTable)
{
    ...
    if (InodeTable != NULL)
    {
        ...
        { /* no available directory descriptors */
...
int32_t EEFS_LibCloseDir(EEFS_DirectoryDescriptor_t* DirectoryDescriptor)
{
    int32_t ReturnCode;
    ...
    if (DirectoryDescriptor != NULL)
    {
        ...
        { /* directory descriptor not in use */
            ReturnCode = EEFS_INVALID_ARGUMENT;
        }
    }
    else
...
EEFS_FileDescriptor_t* EEFS_LibFileDescriptor2Pointer(int32_t FileDescriptor)
{
...
int32_t EEFS_LibChkDsk(EEFS_InodeTable_t* InodeTable, uint32_t Flags)
{
    EEFS_FileHeader_t FileHeader;
    uint32_t          i;
...
uint32_t EEFS_LibGetFileDescriptorsInUse(void)
{
 ...
 * is large enough */
uint32_t EEFS_LibGetFileDescriptorsHighWaterMark(void)
{
