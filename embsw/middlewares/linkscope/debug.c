...
#define DEBUG_QUEUE_SIZE() \
    (debugRxQueue.startPos <= debugRxQueue.endPos ? debugRxQueue.endPos - debugRxQueue.startPos : debugRxQueue.endPos + DEBUG_RXBUF_SIZE - debugRxQueue.startPos)
// 获取队列第pos个元素
#define DEBUG_QUEUE_AT(pos) \
    (debugRxQueue.startPos + (pos) < DEBUG_RXBUF_SIZE ? debugRxQueue.buf[debugRxQueue.startPos + (pos)] : debugRxQueue.buf[debugRxQueue.startPos + (pos) - DEBUG_RXBUF_SIZE])
