...
int32_t EEFS_InitFS(char *DeviceName, uint32_t BaseAddress)
{
...
int32_t EEFS_Mount(char *DeviceName, char *MountPoint)
{
...
int32_t EEFS_UnMount(char *MountPoint)
{
    EEFS_Volume_t               *Volume;
    EEFS_Device_t               *Device;
    int32_t                        ReturnCode;
...
int32_t EEFS_Open(char *Path, uint32_t Flags)
{
...
/* Closes a file. */
int32_t EEFS_Close(int32_t FileDescriptor)
{
    int32_t       ReturnCode;
...
/* Read from a file. */
int32_t EEFS_Read(int32_t FileDescriptor, void *Buffer, uint32_t Length)
{
    int32_t       BytesRead;
    int32_t       ReturnCode;
...
/* Write to a file. */
int32_t EEFS_Write(int32_t FileDescriptor, void *Buffer, uint32_t Length)
{
...
int32_t EEFS_LSeek(int32_t FileDescriptor, uint32_t ByteOffset, uint16_t  Origin)
{
    int32_t       FilePointer;
    int32_t       ReturnCode;
...
int32_t EEFS_Creat(char *Path, uint32_t Mode)
{
    EEFS_SplitPath_t             SplitPath;
    EEFS_Volume_t               *Volume;
    EEFS_Device_t               *Device;
...
int32_t EEFS_Rename(char *OldPath, char *NewPath)
{
...
int32_t EEFS_Stat(char *Path, EEFS_Stat_t *StatBuffer)
{
    EEFS_SplitPath_t             SplitPath;
    EEFS_Volume_t               *Volume;
    EEFS_Device_t               *Device;
...
int32_t EEFS_SetFileAttributes(char *Path, uint32_t Attributes)
{
    EEFS_SplitPath_t             SplitPath;
    EEFS_Volume_t               *Volume;
    EEFS_Device_t               *Device;
...
int32_t EEFS_CloseDir(EEFS_DirectoryDescriptor_t *DirectoryDescriptor)
{
    int32_t       ReturnCode;
