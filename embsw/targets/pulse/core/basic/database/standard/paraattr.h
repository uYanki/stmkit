...
#define B_RW_M1       (V_RW_M1 << ATTR_MODE_Pos) /* read write - stop changes, effective immediately */
#define B_RW_M2       (V_RW_M2 << ATTR_MODE_Pos) /* read write - change immediately, restart takes effect */
...
/**
 * @brief  parameter work mode attribution definition
 */
#define ATTR_RELATE_Pos (ATTR_LENGTH_Pos + ATTR_LENGTH_Len)
 ...
 *
 */
#define ATTR_ACCESS_Pos (ATTR_RELATE_Pos + ATTR_RELATE_Len)
...
typedef struct {
    ...
    union {
        ...
        struct {
            ...
            u16 Relate : ATTR_RELATE_Len; /* limit relate  */
