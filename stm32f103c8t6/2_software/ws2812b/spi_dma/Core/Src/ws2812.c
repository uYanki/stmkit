...
const rgb_t SKY     = {0, 255, 255};
const rgb_t MAGENTA = {255, 0, 220};
const rgb_t YELLOW  = {127, 216, 0};
const rgb_t OEANGE  = {127, 106, 0};
...
*/
void RGB_SetColor(uint8_t LedId, rgb_t Color)
{
    uint8_t i;
    if (LedId > Pixel_NUM)
    {
