...
- **1.2** ：Check this demo: (My terminal: Xshell, you can also choose SecureCRT if you like)
  <img src=".backup/STM32CommandLine-master/Doc/demo.gif" width = "851" height = "576" alt="demo.gif" align=center />

- **1.3** ：Here is my configurations of Xshell:
  ![Xshell_Appearance](.assets/README/Xshell_Terminal.png)
  ![Xshell_Keyboard](.assets/README/Xshell_Keyboard.png)
  ![Xshell_VT_Modes](.assets/README/Xshell_VT_Modes.png)
  ![Xshell_Advanced](.assets/README/Xshell_Advanced.png)
  ![Xshell_Appearance](.assets/README/Xshell_Appearance.png)
...
- **2.3** ：可以移植到任意嵌入式系统，甚至51、AVR、PIC、stm8s、esp8266、esp32、Arduino等。
...
- **2.3** : You can port this shell into an embeded system, even 51, AVR, PIC, stm8s, esp8266, esp32, Arduino and so on..
