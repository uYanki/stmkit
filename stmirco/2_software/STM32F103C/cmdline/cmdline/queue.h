...
extern bool queue_init(uint16_t* Front, uint16_t* Rear, uint8_t* PBase, uint16_t Len);
extern bool queue_full(uint16_t* Front, uint16_t* Rear, uint8_t* PBase, uint16_t Len);
extern bool queue_empty(uint16_t* Front, uint16_t* Rear, uint8_t* PBase, uint16_t Len);
extern bool queue_in(uint16_t* Front, uint16_t* Rear, uint8_t* PBase, uint16_t Len, uint8_t* PData);
extern bool queue_out(uint16_t* Front, uint16_t* Rear, uint8_t* PBase, uint16_t Len, uint8_t* PData);
