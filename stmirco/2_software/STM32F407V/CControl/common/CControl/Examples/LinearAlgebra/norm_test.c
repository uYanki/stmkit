...
int CControl_Test()
{
    ...
    /* Do L1 norm */
    printf("L1 norm of matrix X: %f\n", norm(X, row, column, NORM_METHOD_L1));
    printf("L1 norm of vector Y: %f\n", norm(Y, row, 1, NORM_METHOD_L1));

    /* Do L2 norm */
    printf("L2 norm of matrix X: %f\n", norm(X, row, column, NORM_METHOD_L2));
    printf("L2 norm of vector Y: %f\n", norm(Y, row, 1, NORM_METHOD_L2));

    /* Do Frobenius norm */
    printf("Frobenius norm of matrix X: %f\n", norm(X, row, column, NORM_METHOD_FROBENIUS));
    printf("Frobenius norm of vector Y: %f\n", norm(Y, row, 1, NORM_METHOD_FROBENIUS));
