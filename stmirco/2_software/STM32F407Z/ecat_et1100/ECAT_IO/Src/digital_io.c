...
void APPL_SetLed(UINT32 value)
{
    UINT8 led0 = ((value & 1) ? GPIO_PIN_RESET : GPIO_PIN_SET);
    UINT8 led1 = ((value & 2) ? GPIO_PIN_RESET : GPIO_PIN_SET);
