...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(ECAT_EP_WP_GPIO_Port, ECAT_EP_WP_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : ECAT_EP_LOADED_Pin */
  GPIO_InitStruct.Pin = ECAT_EP_LOADED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(ECAT_EP_LOADED_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : ET1100_INT_Pin */
  GPIO_InitStruct.Pin = ET1100_INT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(ET1100_INT_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : ECAT_SYNC0_Pin ECAT_SYNC1_Pin */
  GPIO_InitStruct.Pin = ECAT_SYNC0_Pin|ECAT_SYNC1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOG, &GPIO_InitStruct);

  /*Configure GPIO pin : ECAT_EP_WP_Pin */
  GPIO_InitStruct.Pin = ECAT_EP_WP_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  HAL_GPIO_Init(ECAT_EP_WP_GPIO_Port, &GPIO_InitStruct);
