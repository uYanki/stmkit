...
#if !(defined (BOARD_RA6M5_EK) || defined (BOARD_RA6M4_EK) || defined (BOARD_RA4M3_EK)||defined(BOARD_RA4M2_EK)) && 0 // Not supported for this MCU
    /* Set Access window.
 ...
 **********************************************************************************************************************/
void flash_hp_bgo_callback(flash_callback_args_t *p_args)
{
