...
const gpt_extended_cfg_t g_timer0_extend =
        ...
        { .output_enabled = false, .stop_level = GPT_PIN_LEVEL_LOW },
          .gtiocb =
          { .output_enabled = false, .stop_level = GPT_PIN_LEVEL_LOW },
          .start_source = (gpt_source_t) (GPT_SOURCE_GPT_A | GPT_SOURCE_NONE), .stop_source = (gpt_source_t) (
                  GPT_SOURCE_NONE),
          .clear_source = (gpt_source_t) (GPT_SOURCE_NONE), .count_up_source = (gpt_source_t) (GPT_SOURCE_NONE), .count_down_source =
...
/* Actual period: 0.01 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0xf4240,
  .duty_cycle_counts = 0x7a120, .source_div = (timer_source_div_t) 0, .channel = 0, .p_callback = g_timer0_callback,
...
dmac_instance_ctrl_t g_transfer_dmac_sci7_rx_ctrl;
transfer_info_t g_transfer_dmac_sci7_rx_info =
{ .transfer_settings_word_b.dest_addr_mode = TRANSFER_ADDR_MODE_INCREMENTED,
  ...
  .num_blocks = 0,
  .length = 1, };
const dmac_extended_cfg_t g_transfer_dmac_sci7_rx_extend =
...
#endif
  .ipl = (8),
  .channel = 1, .p_callback = dmac_sci7_rx_callback, .p_context = NULL, .activation_source = ELC_EVENT_SCI7_RXI, };
const transfer_cfg_t g_transfer_dmac_sci7_rx_cfg =
{ .p_info = &g_transfer_dmac_sci7_rx_info, .p_extend = &g_transfer_dmac_sci7_rx_extend, };
/* Instance structure to use this module. */
const transfer_instance_t g_transfer_dmac_sci7_rx =
{ .p_ctrl = &g_transfer_dmac_sci7_rx_ctrl, .p_cfg = &g_transfer_dmac_sci7_rx_cfg, .p_api = &g_transfer_on_dmac };
dmac_instance_ctrl_t g_transfer_dmac_sci7_tx_ctrl;
transfer_info_t g_transfer_dmac_sci7_tx_info =
{ .transfer_settings_word_b.dest_addr_mode = TRANSFER_ADDR_MODE_FIXED,
  ...
  .num_blocks = 0,
  .length = 1, };
const dmac_extended_cfg_t g_transfer_dmac_sci7_tx_extend =
{ .offset = 1, .src_buffer_size = 1,
...
#endif
  .ipl = (6),
  .channel = 0, .p_callback = dmac_sci7_tx_callback, .p_context = NULL, .activation_source = ELC_EVENT_SCI7_TXI, };
const transfer_cfg_t g_transfer_dmac_sci7_tx_cfg =
{ .p_info = &g_transfer_dmac_sci7_tx_info, .p_extend = &g_transfer_dmac_sci7_tx_extend, };
/* Instance structure to use this module. */
const transfer_instance_t g_transfer_dmac_sci7_tx =
{ .p_ctrl = &g_transfer_dmac_sci7_tx_ctrl, .p_cfg = &g_transfer_dmac_sci7_tx_cfg, .p_api = &g_transfer_on_dmac };
