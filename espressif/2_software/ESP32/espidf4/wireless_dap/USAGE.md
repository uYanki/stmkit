...
![ping_dap](.assets/USAGE/ping_dap.png)

③ 在 `tools\elaphureLink` 中设置代理 

![elaphure_link](.assets/USAGE/elaphure_link.png)

④ 在 `keil` 中选择调试器

![keil_select_debugger](.assets/USAGE/keil_select_debugger.png)
...
![uart_tcp_bridge](.assets/USAGE/uart_tcp_bridge.jpg)
...
esp8266 需要配置 ESP8266_RTOS_SDK 工具链。github 上的 espidf 内是不带的，不能直接编译使用。