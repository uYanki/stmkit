...
public:
    ...
    inline void setRecvBufferDeleted()
    {
        this->isRecvBufferHasBeenDeleted = true;
    }
...
public:
    ...
    inline WebSocketClients(WebSocketClientsCallback fn)
        : fn(fn) {}
    inline void setCallBack(WebSocketClientsCallback fn)
    {
        this->fn = fn;
    }
...
public:
    ...
    inline ExtendedWiFiClient(const WiFiClient& externalClient)
