...
/**
 * @brief Start MD5 accumulation.  Set bit count to 0 and buffer to mysterious initialization constants.
 */
...
/**
 * @brief Calculate and store in 'output' the MD5 digest of 'len' bytes at 'input'.
 *        'output' must have enough space to hold 16 bytes.
