...
static void usbd_hid_custom_in_callback(uint8_t busid, uint8_t ep, uint32_t nbytes)
{
    ...
    hpm_stat_t u32Stat = status_invalid_argument;
    ...
    memset(pOutData, 0, HID_REPORT_CNT - 1);
    ...
    switch (u8Operation)
    {
        case I2C_FUNC_RX :
        {
            ...
            u32Stat = i2c_master_transfer(I2C_BASE, u16DevAddr, pu8XferData, u16XferSize, u16XferFlags);
        ...
        case I2C_FUNC_RD :
        {
            ...
            u32Stat = i2c_master_address_read(I2C_BASE, u16DevAddr, (uint8_t*) &u16MemAddr, (u16XferFlags & I2C_FLAG_MEM_ADDR_16BIT) ? 2 : 1, pu8XferData, u16XferSize);
        ...
        case I2C_FUNC_WR :
        {
            ...
            u32Stat = i2c_master_address_write(I2C_BASE, u16DevAddr, (uint8_t*) &u16MemAddr, (u16XferFlags & I2C_FLAG_MEM_ADDR_16BIT) ? 2 : 1, pu8XferData, u16XferSize);
        ...
        case I2C_FUNC_SCAN :
        {
            ...
            {
                u32Stat = i2c_master_transfer(I2C_BASE, u16DevAddr, &u8RxData, 1, I2C_RD);

                if (u32Stat == status_success)
                {
    ...
    pOutData[0] = (u32Stat & 0xFF);
    pOutData[1] = (u32Stat >> 8);
