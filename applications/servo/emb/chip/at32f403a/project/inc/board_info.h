...
#define DEBUG_UART_BASE  USART3

#define MODBUS_UART_BASE USART3
#define MODBUS_RXDMA_CH  DMA1_CHANNEL2
#define MODBUS_TXDMA_CH  DMA1_CHANNEL3

#define TIM_BASE         TMR6  // Period = 1MS, Tick = 100ns
#define TIM_SCAN_A       TMR1
#define TIM_SCAN_B       TMR7

#define CAN_BASE         CAN2

#define ENC_SPI_BASE     SPI1

/**
 * @brief 硬件接口
 */

#define CONFIG_LED_NUM       0  // 指示灯数量
...
#define CONFIG_BOOTSTRAP_SW  1  // 自举模块

/**
 * @brief 软件功能
 */

#define PWM_CLK_HZ              240000000  // PWM外设时钟
