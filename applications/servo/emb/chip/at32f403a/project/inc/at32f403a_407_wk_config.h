...
/* Private defines -------------------------------------------------------------*/
#define SPI_CS_PIN    GPIO_PINS_15
#define SPI_CS_GPIO_PORT    GPIOC
#define ADC_CUR_W_PIN    GPIO_PINS_3
#define ADC_CUR_W_GPIO_PORT    GPIOA
#define ADC_CUR_V_PIN    GPIO_PINS_4
#define ADC_CUR_V_GPIO_PORT    GPIOA
#define ADC_CUR_U_PIN    GPIO_PINS_0
#define ADC_CUR_U_GPIO_PORT    GPIOB
#define ADC_UMDC_PIN    GPIO_PINS_1
#define ADC_UMDC_GPIO_PORT    GPIOB
