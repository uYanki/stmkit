...
void wk_tmr1_init(void)
{
  ...
  tmr_channel_value_set(TMR1, TMR_SELECT_CHANNEL_4, 12100);
...
void wk_adc1_init(void)
{
  ...
  adc_ordinary_channel_set(ADC1, ADC_CHANNEL_7, 1, ADC_SAMPLETIME_7_5);
  adc_ordinary_channel_set(ADC1, ADC_CHANNEL_6, 2, ADC_SAMPLETIME_7_5);
...
/**
  * @brief  init dma1 channel4 for "i2c2_rx"
  * @param  none
  * @retval none
  */
void wk_dma1_channel4_init(void)
{
  ...
  /* flexible function enable */
  dma_flexible_config(DMA1, FLEX_CHANNEL4, DMA_FLEXIBLE_I2C2_RX);
...
/**
  * @brief  init dma1 channel5 for "i2c2_tx"
  * @param  none
  * @retval none
  */
void wk_dma1_channel5_init(void)
{
  ...
  /* flexible function enable */
  dma_flexible_config(DMA1, FLEX_CHANNEL5, DMA_FLEXIBLE_I2C2_TX);
