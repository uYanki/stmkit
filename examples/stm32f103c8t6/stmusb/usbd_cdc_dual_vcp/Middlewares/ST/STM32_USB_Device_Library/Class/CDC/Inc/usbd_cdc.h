...
#define CDC_IN_EP2                                   0x83U  /* EP1 for data IN */
#define CDC_OUT_EP2                                  0x03U  /* EP1 for data OUT */
#define CDC_CMD_EP2                                  0x84U  /* EP2 for CDC commands */
...
#define USB_CDC_CONFIG_DESC_SIZ                     (9+66+66)// 67U
